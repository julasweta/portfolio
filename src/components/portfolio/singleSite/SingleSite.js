  ...
  return (
    <div className="singleSite">
      <div className="container">
        ...
        <FadeIn><a href={props.info.sites[props.idPost - 1].homepage}  target="_blank" rel="noopener noreferrer" >
         Переглянути сайт
        </a></FadeIn>

        <img src={process.env.PUBLIC_URL + `/images/${props.info.sites[props.idPost - 1].imgfull}.png`} alt="site" />
      </div>
